...
void BMI160_Init() {
    ...
    BMI160_WriteRegister(0x7E, 0b00010001);
    // Power on gyroscope
    BMI160_WriteRegister(0x7E, 0b00010101);
    // Power on magnetometer
    BMI160_WriteRegister(0x6B, 0b00100000);
    BMI160_WriteRegister(0x7E, 0b00011001);
...
void BMI160_WriteRegister(uint8_t addr, uint8_t data) {
    ...
    I2C_WriteMultiple(I2C_A_BASE, 0x69, writeData, 2);
...
uint8_t BMI160_ReadRegister(uint8_t addr) {
    // Complete this function
    I2C_WriteSingle(I2C_A_BASE, 0x69, addr);
    return I2C_ReadSingle(I2C_A_BASE, 0x69);
}
...
void BMI160_MultiReadRegister(uint8_t addr, uint8_t* data, uint8_t num_bytes) {
    // Complete this function
    I2C_WriteSingle(I2C_A_BASE, 0x69, addr);
    I2C_ReadMultiple(I2C_A_BASE, 0x69, data, num_bytes);
    return;
